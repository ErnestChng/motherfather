...
import com.example.motherfather.adapters.UserRecyclerAdapter;
import com.example.motherfather.models.ClusterMarker;
import com.example.motherfather.models.User;
import com.example.motherfather.models.UserLocation;
import com.example.motherfather.util.MyClusterManagerRenderer;
import com.example.motherfather.util.ViewWeightAnimationWrapper;
...
import static com.example.motherfather.Constants.MAPVIEW_BUNDLE_KEY;
        ...
        UserRecyclerAdapter.UserListRecyclerClickListener
{
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (mUserLocations.size() == 0) { // make sure the list doesn't duplicate by navigating back
            if (getArguments() != null) {
                ...
                Log.d(TAG, "size is " + locations.size());
    ...
    public void onUserClicked(int position) {
        ...
        String selecctedUserId = mUserList.get(position).getUser_id();

        for (ClusterMarker clusterMarker : mClusterMarkers) {
            if (selecctedUserId.equals(clusterMarker.getUser().getUser_id())){
